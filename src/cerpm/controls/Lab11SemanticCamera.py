...
class SemanticCameraNode(Node):
    def __init__(self):
        ...
        self.image_save_dir = 'processed_images'
        if not os.path.exists(self.image_save_dir):
            os.makedirs(self.image_save_dir)
        self.image_counter = 0 # Counter for image filenames


    def image_proc_callback(self, msg):
        """
        ...
        self.save_processed_image(cv_image)
    ...
    def detect_vehicle_in_front(self, vehicle_mask):
        """
        Detect if there is a vehicle directly in front within a specified region of interest.
        Args:
        ...
        # Define ROI: central 20% width, bottom 30% height
    ...
    def save_processed_image(self, image):
        ...
        filename = f'{self.image_save_dir}/processed_image_{self.image_counter:05d}.png'

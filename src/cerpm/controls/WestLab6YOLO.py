...
class YoloDetectionNode(Node):
    def __init__(self):
        ...
        self.subscription = self.create_subscription(
            ...
            self.image_callback,                    # Callback function when a message is received
            10)                                     # Queue size
        ...
        self.class_names = open("/home/cae-user/AV_West/WestLab6/coco.names").read().strip().split("\n") # Load class names
        self.net = cv2.dnn.readNetFromDarknet("/home/cae-user/AV_West/WestLab6/yolov3.cfg", "/home/cae-user/AV_West/WestLab6/yolov3.weights") # Load YOLOv3 model
        ...
        self.layer_names = [self.net.getLayerNames()[i - 1] for i in out_layer_indices]
